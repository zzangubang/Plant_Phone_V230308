 ...
 * Use the {@link MainActivity_Work_Data_Humi#newInstance} factory method to
 * create an instance of this fragment.
 */
public class MainActivity_Work_Data_Humi extends Fragment {
    ...
    GetValue gValue;
    String getValueURL = "http://aj3dlab.dothome.co.kr/Test_humiTable_Android.php";
    ...
    public MainActivity_Work_Data_Humi() {
     ...
     * @return A new instance of fragment MainActivity_Work_Data_Humi.
     */
    // TODO: Rename and change types and number of parameters
    public static MainActivity_Work_Data_Humi newInstance(String param1, String param2) {
        MainActivity_Work_Data_Humi fragment = new MainActivity_Work_Data_Humi();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_main_work_data_humi, container, false);
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(getContext(), new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                ...
                webView.loadUrl("http://aj3dlab.dothome.co.kr/Plant_humiGraph.php?date="+selectDate+"&model="+model);
                dialog.show();
                gValue = new GetValue();
    ...
    class GetDate extends AsyncTask<String, Integer, String> {
        ...
        protected void onPostExecute(String str) {
            ...
            try {
                ...
                dateT.setText(date);
                webView.loadUrl("http://aj3dlab.dothome.co.kr/Plant_humiGraph.php?date="+date+"&model="+model);
                gValue = new GetValue();
